        ...
        <div>
            <div className="hero min-h-screen ">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <img src={rumonImg} className="max-w-sm rounded-lg shadow-2xl" alt='Md. Rumon Khan' />
                    <div>
                        <h1 className="text-5xl font-bold">Md. Rumon Khan!</h1>
                        <p className="py-6">A self-motivated and enthusiastic web developer with a deep interest in programming. To work in the Software industry with modern web technologies of different local and multinational Software/ IT agencies of Bangladesh and grow rapidly with increasing responsibilities.</p>
            ...
            <div className="m-12 ">
                <div className="">
                    ...
                    <div className='grid grid-cols-2 md:grid-cols-3'>
                        <Link to='https://warehouse-management-c2a0a.web.app/' target='_blank' className="p-3 text-blue-900 bg-slate-100 m-3">Bd Car House</Link>
                        <Link to='https://candid-beignet-aef95e.netlify.app/' target='_blank' className="p-3 text-blue-900 bg-slate-100 m-3">Elon Musk</Link>
                        <Link to='https://tangerine-chimera-463d0f.netlify.app/' target='_blank' className="p-3  bg-slate-100 text-blue-900 m-3">Laptop review</Link>
                    </div>
